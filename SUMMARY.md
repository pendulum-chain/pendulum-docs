...
* [How to](explore/how-to/README.md)
  * [Prototype UI](explore/how-to/prototype-ui/README.md)
    * [Connect Account](explore/how-to/prototype-ui/connect-account.md)
    * [Spacewalk Bridge](explore/how-to/prototype-ui/spacewalk-bridge.md)
    * [Interacting with the AMM](explore/how-to/prototype-ui/interacting-with-the-amm.md)
    * [Prototype Demo](https://www.youtube.com/watch?v=SOAVV0dEN10)

## Build

* [Introduction](build/introduction.md)
* [Pendulum](build/pendulum/README.md)
  * [Playground UI](build/pendulum/playground-ui/README.md)
    * [Compiling the contract](build/pendulum/playground-ui/compiling-the-contract.md)
    * [Deploying the AMM](build/pendulum/playground-ui/deploying-the-amm.md)
    * [Interacting with the AMM](build/pendulum/playground-ui/interacting-with-the-amm.md)
  * [Running Pendulum locally](build/pendulum/running-pendulum-locally/README.md)
    * [Local relay chain setup](build/pendulum/running-pendulum-locally/local-relay-chain-setup.md)
    * [Local Pendulum chain setup](build/pendulum/running-pendulum-locally/local-pendulum-chain-setup.md)
    * [Troubleshooting](build/pendulum/running-pendulum-locally/troubleshooting.md)
* [Spacewalk Pallet](build/spacewalk-pallet/README.md)
  ...
  * [Connecting to the testchain](build/spacewalk-pallet/connecting-to-the-testchain/README.md)
    ...
    * [Redeem assets](build/spacewalk-pallet/connecting-to-the-testchain/redeem-assets.md)
  * [Connecting to Pendulum](build/spacewalk-pallet/connecting-to-pendulum/README.md)
    * [Running the vault](build/spacewalk-pallet/connecting-to-pendulum/running-the-vault.md)
...
* [Amplitude](build/amplitude.md)
  * [Become a collator](build/amplitude/become-a-collator/README.md)
    ...
    * [External Collators](build/amplitude/become-a-collator/external-collators.md)
* [Pendulum-launch](build/pendulum-launch/README.md)
  ...
  * [🚀 Launch](build/pendulum-launch/launch.md)
  * [Sub-commands](build/pendulum-launch/sub-commands/README.md)
